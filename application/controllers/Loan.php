...
class Loan extends CI_Controller
{
	...
	public function create_multi_offer()
	{
		...
		print_r($employee_type);

		$cashe_pincode_check = $this->loan_model->checkPincodeStatus('pincode_cashe', $pincode);
		if (isset($cashe_pincode_check->pincode)) {
			$cashe_pincode_status = 'Y';	
		} else {
			$cashe_pincode_status = 'N';
		}


		if ($employee_type == '1' && $income >= '50000' && $cashe_pincode_status == 'Y') {
			//CASHe Integration 
		...
		// }
		// if ($pan_card_no !== null) {
		// 	$pan_card_no = strtoupper($pan_card_no);
		// } else {
		// 	$pan_card_no = ''; // Or handle the case appropriately
		// }
		// $data = array (
		// 	"mobilenumber" => $mobile,
		// 	"consent"=> "true",
		...
		// 		)
		// 	);
		// $pincode_check = $this->loan_model->checkPincodeStatus('pincode_fibe', $pincode);
		// if (isset($pincode_check->pincode)) {
		// 	$fibe_pincode_status = 'Y';
		// } 
		// else{
		// 	$fibe_pincode_status = 'N';
		// }
		// if ($profession == 'Salaried' && $income > 30000 && $fibe_pincode_status == 'Y') { 
