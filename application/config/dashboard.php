...
<body class="v-light vertical-nav fix-header fix-sidebar">
                    ...
                    <div class="col-xl-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="media border-bottom-1 p-t-15 p-b-15">
                                    <img src="<?php echo base_url(); ?>/assets/images/avatar/2.jpg" class="mr-3 rounded-circle">
                                    <div class="media-body">
                                        <h5>John Tomas</h5>
                                        <p class="m-b-0">I shared this on my fb wall a few months back,</p>
                                    </div><span class="text-muted f-s-12">April 24, 2018</span>
                                ...
                                <div class="media p-t-15 p-b-15">
                                    <img src="<?php echo base_url(); ?>/assets/images/avatar/3.jpg" class="mr-3 rounded-circle">
                                    <div class="media-body">
                                        <h5>John Tomas</h5>
                                        <p class="m-b-0">I shared this on my fb wall a few months back,</p>
                                    </div><span class="text-muted f-s-12">April 24, 2018</span>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-xs">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="<?php echo base_url(); ?>/assets/images/avatar/1.jpg" class="w-40px rounded-circle m-r-10" alt="">Arden Karn</td>
                                                    <td><span>125</span>
                                                    </td>
                                                    <td>United States</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="<?php echo base_url(); ?>/assets/images/avatar/2.jpg" class="w-40px rounded-circle m-r-10" alt="">Arden Karn</td>
                                                    <td><span>547</span>
                                                    </td>
                                                    <td>Canada</td>
                                                    <td><i class="fa fa-circle-o text-success f-s-12 m-r-10"></i> Active</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="<?php echo base_url(); ?>/assets/images/avatar/3.jpg" class="w-40px rounded-circle m-r-10" alt="">Arden Karn</td>
                                                    <td><span>557</span>
                                                    </td>
                                                    <td>Germany</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="<?php echo base_url(); ?>/assets/images/avatar/4.jpg" class="w-40px rounded-circle m-r-10" alt="">Arden Karn</td>
                                                    <td><span>753</span>
                                                    </td>
                                                    <td>England</td>
                                                    <td><i class="fa fa-circle-o text-success f-s-12 m-r-10"></i> Active</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="<?php echo base_url(); ?>/assets/images/avatar/5.jpg" class="w-40px rounded-circle m-r-10" alt="">Arden Karn</td>
                                                    <td><span>453</span>
                                                    </td>
                                                    <td>China</td>
                                                    <td><i class="fa fa-circle-o text-danger f-s-12 m-r-10"></i> Inactive</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="<?php echo base_url(); ?>/assets/images/avatar/6.jpg" class="w-40px rounded-circle m-r-10" alt="">Arden Karn</td>
                                                    <td><span>658</span>
                                                    </td>
                                                    <td>Japan</td>
                                                    <td><i class="fa fa-circle-o text-success f-s-12 m-r-10"></i> Active</td>
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="<?php echo base_url(); ?>/assets/images/users/2.jpg" class="rounded-circle m-t-15 w-75px" alt="">
                    ...
                    <div class="col-xl-3">
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="<?php echo base_url(); ?>/assets/images/users/1.jpg" class="rounded-circle m-t-10 w-50px" alt="">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="<?php echo base_url(); ?>/assets/images/users/2.jpg" class="rounded-circle m-t-10 w-50px" alt="">
                                    <h6 class="f-w-500 m-t-15">Bob Springer</h6>
                                    <p class="m-b-0 f-s-12">Status: <strong>Online</strong>
                                    </p>
                                    <p class="m-b-0 f-s-12">Response Time: <strong>3 Hours</strong>
    ...
    <script src="<?php echo base_url(); ?>main/js/dashboard-1.js"></script>
</body>
