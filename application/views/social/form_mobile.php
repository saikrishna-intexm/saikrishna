...
//				alert();
				$.ajax({
				type : 'POST',
				url : '<?php echo base_url("social/threeloan_application"); ?>',
				data : data,
				...
				window.location.replace("<?php echo base_url('social/threeloanpage?offer_id='); ?>"+ result.offer_id + "&lead_id=" + result.lead_id);
				//			$.confirm({
