...
})(window,document,'script','dataLayer','GTM-KDHHLV8R');</script>
<!-- End Google Tag Manager -->
</head>

<body>
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KDHHLV8R"
                ...
                <section>
                    <div class="row g-0">
                        <div class="col-12 d-flex justify-content-center pt-3 pb-1">
                            <img src="https://res.cloudinary.com/crunchbase-production/image/upload/c_lpad,f_auto,q_auto:eco,dpr_1/fwbgpokgyxgopaeiym6q" width="100px" class="img-fluid" alt="Logo">
                        </div>
                    </div>
                </section>
                        ...
                        <div class="col-12">
                            <div class="card p-0">
                                ...
                                <div class=" flex-column text-center px-3">
                                    <h4 class="text-dark py-0 my-0"> Stashfin - Personal Loan</h4>
...
<a href="https://trk.i1x.in/click?campaign_id=18&pub_id=12&url_id=2&source=<?php echo @$utm_source; ?>"><button class="btn btn-success w-100 py-3">Download <img width="15px"
...
window.location.href = "https://trk.i1x.in/click?campaign_id=18&pub_id=12&url_id=2&source=<?php echo @$utm_source; ?>";
}, 5000);
</body>
