                        ...
                        <div class="col-12">
                            <div class="card p-0">
                                ...
                                <div class="d-flex justify-content-center text-center">
                                    <h1 class="text-dark ">
                                        <div class="font-weight-normal mb-3"> Congratualations!<br><span class="text-info">Open Indusind Saving Account and get a change to Credit Loan upto 2,00,000/-</span></div>
