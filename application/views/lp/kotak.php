                        ...
                        <div class="col-12">
                            <div class="card p-0">
                                ...
                                <div class="d-flex justify-content-center text-center">
                                    <h1 class="text-dark ">
                                        <div class="font-weight-normal mb-3"> Congratulation!<br><span class="text-info">You are approved for DreamDifferent Credit Card.</span></div>
...
<a href="https://trk.i1x.in/click?campaign_id=17&pub_id=10&url_id=<?php echo @$my_array[0]; ?>&source=<?php echo @$utm_source; ?>"><button class="btn btn-success w-100 py-3">Apply Now <img width="15px"
