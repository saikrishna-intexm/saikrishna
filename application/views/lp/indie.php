...
<head>
    ...
    <title>Indusind Offer Page</title>
                ...
                <section>
                    <div class="row g-0">
                        <div class="col-12 d-flex justify-content-center pt-3 pb-1">
                            <img src="https://yt3.googleusercontent.com/ytc/APkrFKbYEA7nZ6dOcvfDWDMkM9WLWpeY1XzjbjLAW_D_qA=s900-c-k-c0x00ffffff-no-rj" width="100px" class="img-fluid" alt="Logo">
                        </div>
                    </div>
                </section>
                        ...
                        <div class="col-12">
                            <div class="card p-0">
                                ...
                                <div class="d-flex justify-content-center text-center">
                                    <h1 class="text-dark ">
                                        <div class="font-weight-normal mb-3"> Congratulation!<br><span class="text-info">Open Indusind Saving Account and get a chance to Credit Loan upto 2,00,000/-</span></div>
                                ...
                                <div class=" flex-column text-center px-3">
                                    <h2 class="text-dark py-0 my-0"> Indusind </h2>
                                    <p class="py-0 mt-0 mb-3"><strong> <small> No paperwork.<br>
          No Joining & Annual Fee.<br>
          Earn upto 6.75% on your account balance.
                                            </small> </strong></p>
...
<a href="https://trk.i1x.in/click?campaign_id=34&pub_id=2&source=<?php echo @$utm_source; ?>"><button class="btn btn-success w-100 py-3">Apply Now <img width="15px"
