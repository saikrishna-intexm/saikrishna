...
<html lang="en" data-footer="true">
  ...
  <body>
                  ...
                  <table id="datatableRowsAjax" class="data-table nowrap w-100">
                    <thead>
                      <tr>
                        ...
                        <th class="text-muted text-small text-uppercase">Campaign Title</th>
                        <th class="text-muted text-small text-uppercase">Prority URL (1)</th>
                        <th class="text-muted text-small text-uppercase">Prority URL (2)</th>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                          <label class="form-label">Priority URL (1)</label>
                          <textarea class="form-control" rows="2" name="priority_url_one" required></textarea>
                        </div>
						<div class="mb-3">
                          <label class="form-label">Priority URL (2)</label>
                          <textarea class="form-control" rows="2" name="priority_url_two" required></textarea>
                        </div>
                    </div>
	...
	$.post( "<?php echo base_url('admin/create_campaign'); ?>", $( "#createCampaign" ).serialize())
	.done(function( data ) {
		var result = JSON.parse(data);
			if(result.status == 'success'){
				...
				keys: ['enter', 'shift'],
				action: function(){
				window.location.replace("<?php echo base_url('admin/campaign'); ?>");
				}
				}
				}
				});
