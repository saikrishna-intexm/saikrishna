...
<html lang="en">
  ...
  <body class="h-100">
            ...
            <div class="min-h-100 d-flex align-items-center">
              <div class="w-100 w-lg-75 w-xxl-50">
                <div>
                  ...
                  <div class="mb-5">
                    <a class="btn btn-lg btn-outline-white" href="<?php echo base_url(); ?>assets/index.html">Learn More</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="sw-lg-50 px-5">
                ...
                <div class="mb-5">
                  ...
                  <p class="h6">
                    ...
                    <a href="<?php echo base_url(); ?>assets/Pages.Authentication.Register.html">register</a>
                    .
                  </p>
                </div>
                <div>
                  <form id="loginForm" class="tooltip-end-bottom" novalidate>
                    ...
                    <div class="mb-3 filled form-group tooltip-end-top">
                      ...
                      <a class="text-small position-absolute t-3 e-3" href="<?php echo base_url(); ?>assets/Pages.Authentication.ForgotPassword.html">Forgot?</a>
                    </div>
	...
	$.post( "<?php echo base_url('admin/login_validation'); ?>", { email: $("input[name=email]").val(), password: $("input[name=password]").val()})
	.done(function( data ) {
