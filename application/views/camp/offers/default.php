        ...
        <div class="">
            <div class="container-fluid p-0">
                    ...
                    <div class="row g-0 mb-1">
                        <div class="col-12 d-flex">
                            <a href="#" class="mainlogo"><img
                                    src="<?php echo base_url(); ?>assets/cashe/img/lowcredit-header-logo.png"
                                    width="220px" class="img-fluid" alt="Logo"></a>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center py-3">
                                <div class="col-12 d-flex justify-content-center">
                                    <div class="">
                                        <img class="img"
                                            src="<?php echo base_url(); ?>assets/campaign/offers/icons/<?php echo $offer->offer_icon; ?>"
                                            alt="logo" width="120px"
                                            style="width:120px; border-radius: 10px; margin-top: 100px;">
                            ...
                            <div class="d-flex justify-content-center text-center">
                                <h1 class="text-dark ">
                                    <div class="font-weight-normal mb-1" style="color: white;">
                                        <?php echo $offer->offer_message; ?></div>
                                </h1>
                            </div>
                ...
                <div class="form-floating custom-radius-last hero__info__button mt-2">
                    <a href="<?php echo $offer->offer_url . '' . $lead->utm_source . "&p1=" . $lead->lead_id; ?>"><button
                            class="btn btn-success w-100 py-3"
                            style="border-radius:26px; box-shadow: 2px 2px 5px #383838; ">Apply Now <img width="15px"
                                ...
                                <div class="">
                                    <div class="col-12">
                                        ...
                                        <ul style="list-style-type: none; padding: 0;">
                                            <li
                                                style="position: relative; padding-left: 30px; margin-bottom: 10px; margin-left: 15px;">
                                                <span
                                                    style="color: #ff5a6e; position: absolute; left: 0; top: 50%; transform: translateY(-50%);"><i
                                            ...
                                            <li
                                                style="position: relative; padding-left: 30px; margin-bottom: 10px; margin-left: 15px;">
                                                <span
                                                    style="color: #ff5a6e; position: absolute; left: 0; top: 50%; transform: translateY(-120%);"><i
                                                        class="fas fa-check"></i></span>
