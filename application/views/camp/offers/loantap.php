                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center py-3">
                                <div class="col-12 mt-5 d-flex justify-content-center">
                                    <div class="">
                                        <img class="img" style="width:125px;" src="https://etimg.etb2bimg.com/photo/90722335.cms">
                                    </div>
                                </div>
                            </div>
                            <div class="mt-5 d-flex justify-content-center text-center">
                                <h1 class="text-dark ">
                                    <div class="font-weight-normal mb-3" style="color: #4ec9db;"> Congrats, Your loan is soft approved for Upto <span class="text-info"><strong style="color: #4ec9db;">Rs.10,00,000/-</strong></span></div>
                                </h1>
                            </div>
                            <div class=" flex-column text-center px-3">
                                ...
                                <h4 class="py-0 my-0" style="color: #fff;">Loantap</h4>
                            </div>
                        </div>
                    </div>
                </section>
