                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center py-3">
                                <div class="col-12 mt-5 d-flex justify-content-center">
                                    <div class="">
                                        <img class="img" style="width:125px;" src="https://opportunitytrack.in/wp-content/uploads/2024/02/Paisabazaar-under-Scrutiny-for-vendor-related-matters.webp">
                                    </div>
                                </div>
                            </div>
                            <div class="mt-5 d-flex justify-content-center text-center">
                                <h1 class="text-dark ">
                                    <div class="font-weight-normal mb-3" style="color: #4ec9db;"> Congrats, Your loan is soft approved for Upto <span class="text-info"><strong style="color: #4ec9db;">Rs.5,00,000/-</strong></span></div>
                                </h1>
                            </div>
