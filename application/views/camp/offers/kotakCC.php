                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center py-3">
                                <div class="col-12 mt-5 d-flex justify-content-center">
                                    <div class="">
                                        <img class="img" style="width:85vw;" src="https://d2gwgwt9a7yxle.cloudfront.net/Credit_card_page_mobile_8d7d2689a3.png">
                                    </div>
                                </div>
                            </div>
                            <div class="mt-5 d-flex justify-content-center text-center">
                                <h1 class="text-dark">
                                    <div class="font-weight-normal mb-3" style="color: #f37032;">Congrats, You are approved for lifetime free credit card <span class="text-info"></span></div>
                                </h1>
                            </div>
