...
<html lang="en">
  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <h2>A better way to handle your money</h2>
      <p class="para">Exchange money with no hidden fees. Buy crypto, gold and manage your money</p>
      <div class="maininner">
          <form id="regForm">
                 <div class="tab">
                     ...
                     <input class="inputfield" type="text" name="email" placeholder="Enter your Email" required>
					 <label class="form-check-label" >Enter your Mobile</label>
                     <input class="inputfield" type="text" name="mobile" placeholder="Enter your Mobile" required>
                 </div>
                 <div class="tab">
                ...
                <option value="500000">More than 5,00,000                                         </option>
                 ...
                 <div class="tab">
                     ...
                     <input class="inputfield" type="text" name="pincode" placeholder="Enter your pincode" required>
                 </div>
...
function nextPrev(n) {
  ...
  if (currentTab >= x.length) {
	...
	window.location.replace("<?php echo base_url('campaign/process?offer_id='); ?>"+ result.offer_id + "&lead_id=" + result.lead_id);
