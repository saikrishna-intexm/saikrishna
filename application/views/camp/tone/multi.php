...
fbq('init', '1769101570226802');
fbq('track', 'Lead');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=1769101570226802&ev=PageView&noscript=1"
/></noscript>
<!-- End Meta Pixel Code -->
  </head>
  <body>
    ...
    <div class="wrapper">
      ...
      <div class="bankcard">
        <div class="bankcardinner">
          <div class="banklogo"><img src="<?php echo base_url(); ?>/assets/campaign/tone/images/finnable.jpeg" class="img-fluid" alt="Logo"></div>
            <div class="roi">
              <h4>ROI</h4>
              <p>18 - 36%</p>
            </div>
            <div class="loanamount">
              <h4>Loan Amount</h4>
               <p>upto Rs 10,00,000</p>
            </div>
        </div>
        <div class="apply">
          <a href="https://trk.i1x.in/click?campaign_id=24&pub_id=2&source=<?php echo @$utm_source; ?>">Apply Now</a>
         </div>
      </div>

      <div class="bankcard">
        <div class="bankcardinner">
          <div class="banklogo"><img src="<?php echo base_url(); ?>/assets/campaign/tone/images/prefr.jpg" class="img-fluid" alt="Logo"></div>
            <div class="roi">
              <h4>ROI</h4>
              <p>10.99 - 28%</p>
            </div>
        ...
        <div class="apply">
          <a href="https://trk.i1x.in/click?campaign_id=19&pub_id=2&url_id=2&source=<?php echo @$utm_source; ?>">Apply Now</a>
         </div>
      </div> 
	  
	  <div class="bankcard">
        <div class="bankcardinner">
          <div class="banklogo"><img src="<?php echo base_url(); ?>/assets/campaign/tone/images/creditlinks.webp" class="img-fluid" alt="Logo"></div>
            <div class="roi">
              <h4>ROI</h4>
              <p>10.99 - 28%</p>
            </div>
        ...
        <div class="apply">
          <a href="https://trk.i1x.in/click?campaign_id=22&pub_id=2&source=<?php echo @$utm_source; ?>">Apply Now</a>
         </div>
      </div>
