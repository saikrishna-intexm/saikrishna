...
<head>
    ...
    <!-- Style CSS -->
    <link href="<?php echo base_url(); ?>assets/campaign/css/successstyle4.css" rel="stylesheet">
    <style>
                ...
                <section>
                    <div class="row g-0 mb-2">
                        <div class="col-12 d-flex pt-2 pb-1">
                            <a href="#" class="mainlogo"><img src="<?php echo base_url(); ?>assets/cashe/img/logo.png" width="120px" class="img-fluid" alt="Logo"></a>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center py-3">
                                <div class="col-12 mt-5 d-flex justify-content-center">
                                    <div class="">
                                        <img class="img" style="width:125px;" src="https://miro.medium.com/v2/resize:fit:400/1*1qCzl41x8K7_MHzC5An7hA.png">
                                    </div>
                                </div>
                            </div>
                            <div class="mt-5 d-flex justify-content-center text-center">
                                <h1 class="text-dark">
                                    <div class="font-weight-normal mb-3" style="color: #f37032;">Congrats, Your application is ready for Disbursal of up to <span class="text-info"><strong style="color: #f37032;">Rs.3,00,000</strong></span></div>
                                </h1>
                            </div>
                            <div class=" flex-column text-center px-3">

                                <p class="py-0 mt-0 mb-3"><strong> <small style="color: #fff;">Complete KYC with our partner..T&C Apply..</small> </strong></p>
