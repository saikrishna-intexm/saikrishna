                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center py-3">
                                <div class="col-12 mt-5 d-flex justify-content-center">
                                    <div class="">
                                        <img class="img" style="width:125px;" src="<?php echo base_url(); ?>assets/campaign/img/Aditya.png">
                                    </div>
                                </div>
                            ...
                            <div class="mt-5 d-flex justify-content-center text-center">
                                ...
                                <h1 class="text-dark ">
                                    <div class="font-weight-normal mb-3" style="color: #eee03b;"> Congrats, Your loan is soft approved for Upto
                                        <span class="text-info"><strong style="color: #eee03b;"> Rs.
                            ...
                            <div class=" flex-column text-center px-3">
                                ...
                                <p class="py-0 mt-0 mb-3"><strong> <small></small> </strong></p>
