...
<script>
  ...
  fbq('init', '1818518158541844');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=1818518158541844&ev=PageView&noscript=1"
/></noscript>
<!-- End Meta Pixel Code -->
</head>
<body>
      ...
      <div class="header__wrapper">
        <div class="header__logo d-flex justify-content-center align-items-center">
          <!--a href="index.html" class="mr-5 border-right pr-5 ">
            <img src="<?php echo base_url(); ?>assets/offers/images/logo-new.jpeg" alt="logo" class="pr-2 new-img">
          </a-->
          <a href="index.html" class="mt-3">
            <img src="https://images.squarespace-cdn.com/content/v1/6049e33a3512a120620cfe14/1669330411828-95Y0KKSWFNID6OTJLZUY/CM-Logo-1920.png" alt="logo" class="new-img" style="width: 300px; height:auto !important">
          </a>
        </div>
...
<!-- Thanks message -->
  ...
  <div class="confetti" style="height: 130px;">
        ...
        <div class="container pb-md-5">
          <div class="compare__info0 pb-md-5">
            <div class="section-header">
              <h2 class="h2-heading light mb-5" style="font-size: 3rem !important;">Pre-Qualified for up to Rs. 5,00,000 Claim the free offer from Credit Mantri Cash Loan<span class="dot">.</span></h2>
              <h5 class="headline light highlight fancy" style="font-size: 2rem !important;"><strong class="small">No hidden charges.</h5>.
              <h2 class="text-success h3-heading mb-5 font-weight-bold" style="font-size: 2rem !important;">Instant disbursal.</h2>
              <h2 class="text-success h3-heading mb-5 font-weight-bold" style="font-size: 2rem !important;">Interest rates starting @9.9% p.a.</h2>
              <h2 class="text-success h3-heading mb-5 font-weight-bold" style="font-size: 2rem !important;">Flexible EMI options.</h2>
              <p class="text-dark">I agree to Credit Mantri's <a href="">T&C</a> and <a href="">Privacy Policy</a> , consent to
                CKYC and <a href="">authorize</a> Credit Mantri to retrieve my credit report</p>
            </div>
...
?>
                <a href="https://trk.hexawebony.com/click?campaign_id=29652&pub_id=1398&source=<?php echo @$utm_source; ?>" class="hero__info__button"><span>Apply Now!</span></a>
              </div>
...
//window.location.href = "https://trk.hexawebony.com/click?campaign_id=29652&pub_id=1398&source=<?php echo @$utm_source; ?>";
}, 5000);
  </script>
