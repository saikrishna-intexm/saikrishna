      ...
      <div class="header__wrapper">
        <div class="header__logo d-flex justify-content-center align-items-center">
          ...
          <a href="index.html" class="mt-3">
            <img src="https://prefr.com/static/img/v3/prefr.svg" alt="logo">
          </a>
        </div>
        ...
        <div class="container pb-md-5">
          <div class="compare__info0 pb-md-5">
            <div class="section-header">
              <h2 class="h2-heading light mb-5" style="font-size: 3rem !important;">Pre-Qualified for up to Rs. 5,00,000 Claim the free offer from Prefr Cash Loan<span class="dot">.</span></h2>
              ...
              <p class="text-dark">I agree to Prefr's <a href="">T&C</a> and <a href="">Privacy Policy</a> , consent to
                CKYC and <a href="">authorize</a> Prefr to retrieve my credit report</p>
            </div>
...
?>
                <a href="https://marketplace.creditvidya.com/valueleaf?utm_source=VL3&utm_medium=5743_<?php echo @$utm_source; ?>" class="hero__info__button"><span>Apply Now!</span></a>
              </div>
...
window.location.href = "https://marketplace.creditvidya.com/valueleaf?utm_source=VL3&utm_medium=5743_<?php echo @$utm_source; ?>";
}, 5000);
  </script>
