...
<script>
  ...
  fbq('init', '1003944554122637');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=1003944554122637&ev=PageView&noscript=1"
/></noscript>
<!-- End Meta Pixel Code -->
</head>
<body>
    ...
    <div class="container">
      <div class="header__wrapper">
        <div class="header__logo d-flex justify-content-center align-items-center">
          ...
          <a href="index.html">
            <img src="https://etimg.etb2bimg.com/photo/95275293.cms" alt="logo" style="height: 100px">
          </a>
        </div>
...
<!-- Thanks message -->
  ...
  <div class="confetti">
    ...
    <div class="confetti-piece"></div>
    <div class="confetti-piece"></div>
    <div class="icon text-danger display-2 font-weight-bold">Congratualations!</div>
  </div>
  </section>
  <!--compare start-->
        ...
        <div class="container pb-md-5">
          <div class="compare__info0 pb-md-5">
            <div class="section-header">
              <h2 class="h2-heading light mb-5">Pre-Qualified for up to Rs. 5,00,000 Claim the free offer from Navi Cash Loan<span class="dot">.</span></h2>
              <h5 class="headline light highlight fancy"><strong class="small">No hidden charges.</h5>.
              <h2 class="text-success h3-heading mb-5 font-weight-bold">Instant disbursal.</h2>
              <h2 class="text-success h3-heading mb-5 font-weight-bold">Interest rates starting @9.9% p.a.</h2>
              <h2 class="text-success h3-heading mb-5 font-weight-bold">Flexible EMI options.</h2>
              <p class="text-dark">I agree to Navi's <a href="">T&C</a> and <a href="">Privacy Policy</a> , consent to
                CKYC and <a href="">authorize</a> Navi to retrieve my credit report</p>
            </div>
            <div class="compare__info__img pb-md-5">
              <div class="hero__info__buttons mb-md-3">
                <a href="http://tracking.buddyloan.com/aff_c?offer_id=2591&aff_id=5964&source=<?php echo $lead->utm_source; ?>" class="hero__info__button"><span>Apply Now!</span></a>
              </div>
