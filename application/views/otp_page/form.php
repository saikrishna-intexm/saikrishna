                ...
                <section>
                    <div class="row g-0">
                        <div class="col-12 d-flex justify-content-start pt-3 pb-1">
                            <img src="<?php echo base_url(); ?>assets/cashe/img/logo.png" width="100px" class="img-fluid" alt="Logo">
                        </div>
                    </div>
                </section>
                ...
                <section class="position-relative ">
                    <div class="row text-left g-0">
                        ...
                        <div class="col-7 pr-0 pe-0 pt-3">
                            <h1>Sumit your OTP
to <span class="text-info"><span class="font-big"><strong class="font-rupee"></strong> Unlock your Approved Cash Loan</span></span> </span>
                            </h1>
                        ...
                        <div class="col-12">
                            <div class=" p-0">
                                <div class="form-floating custom-radius-middle  mb-3">
                                    <input type="number" class="form-control w-100" id="floatingPassword" name="otp"
                                        placeholder="OTP" required>
                                    <label for="floatingPassword">Enter Your OTP</label>
                                </div>
                                <div class="form-floating custom-radius-last hero__info__button">
<input type="hidden" id="mobile" name="mobile" value="<?php echo @$_GET['m']; ?>">
<input type="hidden" id="hash" name="hash" value="<?php echo @$_GET['hash']; ?>">
<input type="hidden" id="source" name="source" value="<?php echo @$_GET['source']; ?>">
                                    <button class="btn btn-success w-100 py-3">Submit <img width="15px"
...
$.ajax({
type : 'POST',
url : '<?php echo base_url("lp/otp_verification"); ?>',
data : data,
...
success: function(data) {
    ...
    if(result.status == 'success'){
       window.location.replace("<?php echo base_url('lp/otp_page/creditscore?utm_source='); ?>"+ result.utm_source);
//            $.confirm({
...
//            });
        ...
        $.confirm({
        title: 'Sorry!',
        content: 'OTP Your Entered Expired or In-correct!',
        buttons: {
        somethingElse: {
        text: 'Okay',
        btnClass: 'btn-blue',
