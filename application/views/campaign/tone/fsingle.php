...
<html lang="en">
  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <h2>Quick Cash Loan in 5 Mins</h2>
      <p class="para">Our instant cash loan can help! Get approved in minutes and access funds within 5 minutes</p>
      <div class="maininner">
          <form id="regForm">
                 <div class="tab">
...
function nextPrev(n) {
  ...
  if (currentTab >= x.length) {
	...
	$.ajax({
	type : 'POST',
	url : '<?php echo base_url("campaign/create_multi_loan"); ?>',
	data : data,
