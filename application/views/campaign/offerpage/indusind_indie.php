...
<head>
    ...
    <!-- Style CSS -->
    <link href="<?php echo base_url(); ?>assets/campaign/css/successstyle1.css" rel="stylesheet">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Noto+Sans:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
    <link href="<?php echo base_url(); ?>assets/campaign/css/successstyle5.css" rel="stylesheet">
    <style>
        * {
    ...
    <main>
        <div class="">
            <div class="container">
                ...
                <section class="cardscuess mb-3" style="">
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center py-3">
                                <div class="col-12 d-flex justify-content-center">
                                    <div class="">
                                        <img class="img" style="width:120px;" src="<?php echo base_url(); ?>assets/campaign/img/indu.png">
                                    </div>
                                </div>
                            </div>
                            <div class=" d-flex justify-content-center text-center">
                                <h1 class="text-dark ">
                                    <div class="font-weight-normal mb-2" style="color: white;"> Congrats, Your application is ready for Disbursal of up to <span class="text-info"><strong style="color: #349ECD;">Rs.3,00,000/-</strong></span></div>
                                </h1>
                            </div>
                            <div class=" flex-column text-center px-3">
                                <p class="py-0 mt-0 mb-2" style="color: white;"><strong> <small>Complete KYC with our partner *T&C Apply</small> </strong></p>
                                <h4 class="py-0 my-0" style="color: #fff;">IndusInd Bank</h4>
                            </div>
                        </div>
                    </div>
                </section>
