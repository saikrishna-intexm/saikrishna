...
<body style="
background: url('<?php echo base_url(); ?>assets/campaign/img/bg-5.jpg') no-repeat center center fixed;
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center py-3">
                                <div class="col-12 d-flex justify-content-center">
                                    <div class="">
                                        <img class="img" style="width:120px;" src="<?php echo base_url(); ?>assets/campaign/img/Aditya.png">
                                    </div>
                                </div>
                            ...
                            <div class="d-flex justify-content-center text-center">
                                ...
                                <h1 class="text-dark ">
                                    <div class="font-weight-normal mb-2" style="color: #fff;"> Congrats, Your loan is soft approved for Upto
                                        <span class="text-info"><strong style="color: #EECB53;"> Rs.
                                                3,00,000.</strong></span>
                                    </div>
                                </h1>
                            </div>
                            <div class=" flex-column text-center px-3">
                                ...
                                <p class="py-0 mt-0 mb-2"><strong> <small></small> </strong></p>
                                <h4 class="py-0 my-0" style="color: #fff;">Aditya Birla Capital</h4>
                            </div>
