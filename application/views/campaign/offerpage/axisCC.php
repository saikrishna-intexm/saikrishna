                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center py-3">
                                <div class="col-12 mt-5 d-flex justify-content-center">
                                    <div class="">
                                        <img class="img" style="width:40vw;" src="https://www.paisabazaar.com/wp-content/uploads/2020/01/axis-bank-ace-credit-card-1.jpg">
                                    </div>
                                </div>
                            </div>
                            <div class="mt-5 d-flex justify-content-center text-center">
                                <h1 class="text-dark">
                                    <div class="font-weight-normal mb-3" style="color: #fff;">Congrats User!  <br> <span style="font-size: 19px" >You are approved for lifetime free credit card</span></div>
                                </h1>
                            </div>
                            <div class=" flex-column text-center px-3">
                                ...
                                <h4 class="py-0 my-0" style="color: #fff;">Axis Bank</h4>
                            </div>
                        </div>
                    </div>
                </section>
