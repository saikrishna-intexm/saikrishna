...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Noto+Sans:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
    <link href="<?php echo base_url(); ?>assets/campaign/css/successstyle9.css" rel="stylesheet">
    <style>
        * {
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center py-3">
                                <div class="col-12  d-flex justify-content-center">
                                    <div class="">
                                        <img class="img" style="width:125px;" src="https://storage.googleapis.com/iifl-finance-storage/files/iifl_insights/images/IIFL%2520Finance%2520%25286%2529.jpg">
                                    </div>
                                </div>
                            </div>
                            <div class=" d-flex justify-content-center text-center">
                                <h1 class="text-dark ">
                                    <div class="font-weight-normal mb-2" style="color: white;"> Congrats, Your application is ready for Disbursal of up to <span class="text-info"><strong style="color: #F37023;">Rs.3,00,000/-</strong></span></div>
                                </h1>
                            </div>
