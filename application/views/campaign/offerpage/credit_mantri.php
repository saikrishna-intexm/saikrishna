...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Noto+Sans:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
    <link href="<?php echo base_url(); ?>assets/campaign/css/successstyle15.css" rel="stylesheet">
    <style>
       * {
...
<script type='text/javascript'>
  ...
  window._tfa.push({notify: 'event', name: 'page_view', id: 1552700});
  !function (t, f, a, x) {
  ...
  '//cdn.taboola.com/libtrc/unip/1552700/tfa.js',
  'tb_tfa_script');
</script>
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center py-3">
                                <div class="col-12  d-flex justify-content-center">
                                    <div class="">
                                        <img class="img" style="width:120px;" src="https://images.squarespace-cdn.com/content/v1/6049e33a3512a120620cfe14/1669330411828-95Y0KKSWFNID6OTJLZUY/CM-Logo-1920.png">
                                    </div>
                                </div>
                            </div>
                            <div class=" d-flex justify-content-center text-center">
                                <h1 class="text-dark ">
                                    <div class="font-weight-normal mb-2" style="color: #fff;">Check your FREE CREDIT SCORE to get a loan upto <span class="text-info"><strong style="color: #94C850;">Rs.3,00,000/-</strong></span></div>
                                </h1>
                            </div>
                            <div class=" flex-column text-center px-3">
                                <h4 class="py-0 my-0" style="color: white;">Complete the application and Transfer the amount</h4>
                                <h4 class="py-0 my-0" style="color: #fff;">Creditmantri</h4>
                            </div>
                        </div>
                    </div>
                </section>
