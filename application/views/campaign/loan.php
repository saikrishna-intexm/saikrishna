         ...
         <section>
            <div class="row g-0 mb-2">
               <div class="col-12 d-flex pt-2 pb-1">
                  <a href="<?php echo base_url(); ?>" class="mainlogo"><img src="<?php echo base_url(); ?>/assets/cashe/img/logo.png" width="120px" class="img-fluid" alt="Logo"></a>
               </div>
            </div>
         </section>
         <!--<section>
...
//				alert();
				$.ajax({
				type : 'POST',
				url : '<?php echo base_url("campaign/create_multi_offer"); ?>',
				data : data,
        ...
        function validateForm() {
            ...
            if (currentTab === 0) {
               ...
               // Step 2 validation
               y = x[currentTab].querySelector('select[name="income"]');
               if (y.value === "") {
                     valid = false;
