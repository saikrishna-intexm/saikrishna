        ...
        <div class="">
            <div class="container">
                ...
                <section>
                    <div class="row">
                        <div class="col-12">
                           <a href="https://trk.ultraind.in/click?campaign_id=2174&pub_id=405&source=<?php echo @$_GET['utm_source'] ; ?>"><img src="<?php echo base_url(); ?>assets/offerTwo/img/fimone_banner.jpg"
...
$.ajax({
type : 'POST',
url : '<?php echo base_url("offerTwo/loan_application_ck"); ?>',
data : data,
