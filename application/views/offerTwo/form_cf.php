        ...
        <div class="">
            <div class="container">
                ...
                <section>
                    <div class="row">
                        <div class="col-12">
                           <a href="https://marketplace.creditvidya.com/valueleaf?utm_source=VL3&utm_medium=5953_<?php echo @$_GET['utm_source'] ; ?>"><img src="<?php echo base_url(); ?>assets/offerTwo/img/fimoney_banner.jpg"
...
$.ajax({
type : 'POST',
url : '<?php echo base_url("offerTwo/loan_application_cf"); ?>',
data : data,
