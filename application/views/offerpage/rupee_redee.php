                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center py-3">
                                <div class="col-12  d-flex justify-content-center">
                                    <div class="">
                                        <img class="img" style="width:120px;" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRhU5TBU43N4wikZHd8cFXrNNyM4Bl74pKiAw&s">
                                    </div>
                                </div>
                            </div>
                            <div class=" d-flex justify-content-center text-center">
                                <h1 class="text-dark ">
                                    <div class="font-weight-normal mb-2" style="color: #fff;">Instant personal loans at your fingertips loan upto <span class="text-info"><strong style="color: #94C850;">Rs.1,49,000/-</strong></span></div>
                                </h1>
                            </div>
                            <div class=" flex-column text-center px-3">
                                <h4 class="py-0 my-0" style="color: white;">Instant personal loans at your fingertips loan upto</h4>
                                <h4 class="py-0 my-0" style="color: #fff;">Rupeeredee</h4>
                            </div>
                        </div>
                    </div>
                </section>
