...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Noto+Sans:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
    <link href="<?php echo base_url(); ?>assets/campaign/css/successstyle8.css" rel="stylesheet">
    <style>
        * {
...
<body data-new-gr-c-s-check-loaded="14.1137.0" data-gr-ext-installed="" style="
background: url('<?php echo base_url(); ?>assets/campaign/img/Frame-1.jpg') no-repeat center center fixed;
            ...
            <div class="container">
                ...
                <section>
                    <div class="row g-0 mb-1">
                        <div class="col-12 d-flex pt-1 pb-1">
                            <a href="#" class="mainlogo"><img src="<?php echo base_url(); ?>assets/cashe/img/logo.png" width="100px" class="img-fluid" alt="Logo"></a>
                        </div>
                    </div>
                </section>
...
background: linear-gradient(to right, #91EAE4, #86A8E7, #7F7FD5); */
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center py-3">
                                <div class="col-12 d-flex justify-content-center">
                                    <div class="">
                                        <img class="img" style="width:120px;" src="https://akm-img-a-in.tosshub.com/businesstoday/images/story/202304/idfc-first-bank-sixteen_nine.jpg?size=948:533">
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex justify-content-center text-center">
                                <h1 class="text-dark">
                                    <div class="font-weight-normal mb-2" style="color: #fff;">Open Zero balance account with IDFC to process your Loan application. <span class="text-info"><strong style="color: #ED1C24;">Rs.2,57,000</strong></span></div>
                                </h1>
                            </div>
                            <div class=" flex-column text-center px-3">

                                <p class="py-0 mt-0 mb-2"><strong> <small style="color: #fff;">Complete KYC with our partner..T&C Apply..</small> </strong></p>
                                <h4 class="py-0 my-0" style="color: #fff;">IDFC FIRST Bank</h4>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="plStepsSection">
                                <div class="plStepsHeading" style="color: #fff;">
                                    03 Easy Steps
                                </div>
                                ...
                                <div class="plStepsDescription" style="color: #fff;">
        ...
        <footer class="bg-dark px-3 mt-2">
            <div class="row py-3">
