...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Noto+Sans:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
    <link href="<?php echo base_url(); ?>assets/campaign/css/successstyle3.css" rel="stylesheet">
    <style>
        * {
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center py-3">
                                <div class="col-12  d-flex justify-content-center">
                                    <div class="">
                                        <img class="img" style="width:125px;" src="https://images.sftcdn.net/images/t_app-icon-m/p/32914497-91bb-4f89-befb-2e13ec533f33/4230848133/lendingplate-personal-loan-app-logo">
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex justify-content-center text-center">
                                <h1 class="text-dark ">
                                    <div class="font-weight-normal mb-2" style="color: white;"> Congrats, Your application is ready for Disbursal of up to <span class="text-info"><strong style="color: red;">Rs.3,00,000/-</strong></span></div>
                                </h1>
                            </div>
                            <div class=" flex-column text-center px-3">
                                <p class="py-0 mt-0 mb-3" style="color: white;"><strong> <small>Complete KYC with our partner *T&C Apply</small> </strong></p>
                                <h4 class="py-0 my-0" style="color: #fff;">Lendingplate</h4>
                            </div>
                        </div>
                    </div>
                </section>
