                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="mt-5 d-flex justify-content-center text-center">
                                <h1 class="text-dark ">
                                    <div class="font-weight-normal mb-3" style="color: white;"> Congrats, Your application is ready for Disbursal of up to <span class="text-info"><strong style="color: red;">Rs.1,00,000/-</strong></span></div>
                                </h1>
                            </div>
