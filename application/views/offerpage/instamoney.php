...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Noto+Sans:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
    <link href="<?php echo base_url(); ?>assets/campaign/css/successstyle11.css" rel="stylesheet">
    <style>
         * {
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center py-3">
                                <div class="col-12 d-flex justify-content-center">
                                    <div class="">
                                        <img class="img" style="width:120px;" src="https://www.instamoney.app/wp-content/uploads/2022/09/InstaMoneyLogo.jpg">
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex justify-content-center text-center">
                                <h1 class="text-dark">
                                    <div class="font-weight-normal mb-2" style="color: #fff;"> Congrats, Your loan is soft approved for Upto <span class="text-info"><strong style="color: #486EDD;">Rs.3,00,000/-</strong></span></div>
                                </h1>
                            </div>
                            <div class=" flex-column text-center px-3">
                                ...
                                <h4 class="py-0 my-0" style="color: #fff;">Insta Money</h4>
                            </div>
                        </div>
                    </div>
                </section>
