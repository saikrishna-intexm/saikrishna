...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Noto+Sans:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
    <link href="<?php echo base_url(); ?>assets/campaign/css/successstyle16.css" rel="stylesheet">
    <style>
         * {
    ...
    <main>
        <div class="">
            <div class="container">
                ...
                <section class="cardscuess mb-2" style="">
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center py-3">
                                <div class="col-12 d-flex justify-content-center">
                                    <div class="">
                                        <img class="img" style="width:125px;" src="https://www.axisbank.com/images/default-source/revamp_new/progresswithus/axis-bank-logo-800x533.jpg">
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex justify-content-center text-center">
                                <h1 class="text-dark ">
                                    <div class="font-weight-normal mb-2" style="color: white;"> Congrats, Your application is ready for Disbursal of up to <span class="text-info"><strong style="color: #971C4F;">Rs.3,00,000/-</strong></span></div>
                                </h1>
                            </div>
