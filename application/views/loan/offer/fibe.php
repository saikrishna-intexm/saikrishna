                        ...
                        <div class="col-12">
                            <div class="card p-0">
                                ...
                                <div class="d-flex justify-content-center text-center">
                                    <h1 class="text-dark ">
                                        <div class="font-weight-normal mb-3"> Congratulations! <br><span class="text-info">You have Pre-approved offer from fibe upto Rs. <?php echo $api_response->sanctionLimit; ?></span></div>
                                ...
                                <div class=" flex-column text-center px-3">
                                    ...
                                    <p class="py-0 mt-0 mb-3"><strong> <small> Tenure upto: <?php echo $api_response->highestTenure; ?> Months. <br>
