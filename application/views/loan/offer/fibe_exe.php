                        ...
                        <div class="col-12">
                            <div class="card p-0">
                                ...
                                <div class="d-flex justify-content-center text-center">
                                    <h1 class="text-dark ">
                                        <div class="font-weight-normal mb-3"> Customer Already Exists! <br><span class="text-info">You're existing customer of Fibe, Please download fibe app and check your eligibility on Fibe.</span></div>
                                ...
                                <div class=" flex-column text-center px-3">
                                    ...
                                    <!-- <p class="py-0 mt-0 mb-3"><strong> <small> Eligible Limit: <?php //echo $api_response->inPrincipleLimit; ?><br>
                                    <p class="py-0 mt-0 mb-3"><strong> <small> Tenure: <?php// echo $api_response->inPrincipleTenure; ?> Months<br> -->
Low interest<br>
Hassle-free process
                                            </small> </strong></p>
...
<!-- <a href="<?php //echo $lead->redirection_url;?>"><button class="btn btn-success w-100 py-3">Download & Apply <img width="15px"
