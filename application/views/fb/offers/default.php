...
<head>
   ...
   <script>
      ...
      })(window, document, 'script', 'dataLayer', 'GTM-KDHHLV8R');
   </script>
...
-o-background-size: cover;">
    ...
    <!-- <div class="confetti" style="position: absolute;">
     ...
     <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KDHHLV8R" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
        ...
        <div class="">
            <div class="container-fluid p-0">
                ...
                <div class="form-floating custom-radius-last hero__info__button mt-2">
                    <a href="<?php echo $offer->offer_url . '' . $lead->utm_source . "&p1=". $lead->lead_id; ?>"><button class="btn btn-success w-100 py-3" style="border-radius:26px; box-shadow: 2px 2px 5px #383838;">Apply Now
                    <img width="15px" src="<?php echo base_url(); ?>assets/campaign/img/right.svg" class="img-fluid align-middle me-1" alt=""></button></a>
