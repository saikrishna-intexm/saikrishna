                        ...
                        <div class="col-12">
                            <div class="card p-0">
                                ...
                                <div class="d-flex justify-content-center text-center">
                                    <h1 class="text-dark ">
                                        <div class="font-weight-normal mb-3"> Congratulation!<br><span class="text-info">You are pre-qualified for FI Money A/c, with no hidden charges.</span></div>
...
<a href="https://s1.whistleloop.com/?linkid=15880&offerid=542&publisher_id=519&parentid=50&sub_id1=<?php echo @$utm_source; ?>"><button class="btn btn-success w-100 py-3">Apply Now <img width="15px"
