                ...
                <section>
                    <div class="row g-0">
                        <div class="col-12 d-flex justify-content-center pt-3 pb-1">
                            <img src="https://cdn.iconscout.com/icon/free/png-256/free-bajaj-finserv-2709178-2249165.png?f=webp" width="100px" class="img-fluid" alt="Logo">
                        </div>
                    </div>
                </section>
                        ...
                        <div class="col-12">
                            <div class="card p-0">
                                ...
                                <div class="d-flex justify-content-center text-center">
                                    <h1 class="text-dark ">
                                        <div class="font-weight-normal mb-3"> Approval is Ready for upto<br><span class="text-info">Rs. 3,00,000</span></div>
                                ...
                                <div class=" flex-column text-center px-3">
                                    <h4 class="text-dark py-0 my-0"> Bajaj Finance</h4>
...
<a href="https://trk.i1x.in/click?campaign_id=84&pub_id=2&url_id=3&source=<?php echo @$utm_source; ?>"><button class="btn btn-success w-100 py-3">Apply Now <img width="15px"
