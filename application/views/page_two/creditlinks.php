                ...
                <section>
                    <div class="row g-0">
                        <div class="col-12 d-flex justify-content-center pt-3 pb-1">
                            <img src="https://creditlinks-lap.s3.ap-south-1.amazonaws.com/static/1669802513-CreditLinks_blue_logo.webp" width="100px" class="img-fluid" alt="Logo">
                        </div>
                    </div>
                </section>
                        ...
                        <div class="col-12">
                            <div class="card p-0">
                                ...
                                <div class=" flex-column text-center px-3">
                                    <h3 class="text-dark py-0 my-0"> Creditlinks - Personal Loan</h3>
...
<a href="https://intexm.gotrackier.com/click?campaign_id=22&pub_id=2&source=<?php echo @$utm_source; ?>"><button class="btn btn-success w-100 py-3">Apply Now <img width="15px"
