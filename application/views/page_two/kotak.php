...
<a href="https://trk.i1x.in/click?campaign_id=17&pub_id=11&url_id=<?php echo @$my_array[0]; ?>&source=<?php echo @$utm_source; ?>"><button class="btn btn-success w-100 py-3">Apply Now <img width="15px"
