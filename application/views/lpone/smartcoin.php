...
<head>
    ...
    <title>SmartCoin - Personal Loan Page</title>
                ...
                <section>
                    <div class="row g-0">
                        <div class="col-12 d-flex justify-content-center pt-3 pb-1">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTMa1uHLvKbSxN8uxKkOXwh23CiQfjec1LaKioi6To&s" width="100px" class="img-fluid" alt="Logo">
                        </div>
                    </div>
                </section>
                        ...
                        <div class="col-12">
                            <div class="card p-0">
                                ...
                                <div class=" flex-column text-center px-3">
                                    <h4 class="text-dark py-0 my-0"> SmartCoin - Personal Loan App</h4>
...
<a href="https://l7dg.app.link/PWknXCszFAb?%243p=a_custom_1193774076752404719&aaid={aaid}&idfa={idfa}&~ad_set_name=5743_subid&~campaign=buddyloan_d_5743_<?php echo @$utm_source; ?>&~click_id={click_id}&~creative_name={creative_name}&~secondary_publisher_id=5743_subid"><button class="btn btn-success w-100 py-3">Download <img width="15px"
