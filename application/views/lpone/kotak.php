                        ...
                        <div class="col-12">
                            <div class="card p-0">
                                ...
                                <div class="d-flex justify-content-center text-center">
                                    <h1 class="text-dark ">
                                        <div class="font-weight-normal mb-3"> Congratualations!<br><span class="text-info">You are approved for DreamDifferent Credit Card.</span></div>
                                ...
                                <div class=" flex-column text-center px-3">
                                    <h2 class="text-dark py-0 my-0"> Kotak 811 </h2>
                                    <p class="py-0 mt-0 mb-3"><strong> <small> No paperwork.<br>
          No Joining & Annual Fee.<br>
          Shop online with Kotak811 credit card for 2 reward points
                                            </small> </strong></p>
...
<a href="https://s1.whistleloop.com/?linkid=5689&offerid=52&publisher_id=519&parentid=50&sub_id1=<?php echo @$utm_source; ?>"><button class="btn btn-success w-100 py-3">Apply Now <img width="15px"
