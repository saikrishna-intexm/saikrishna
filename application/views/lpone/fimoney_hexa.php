                ...
                <section>
                    <div class="row g-0">
                        <div class="col-12 d-flex justify-content-center pt-3 pb-1">
                            <img src="https://vtlogo.com/wp-content/uploads/2023/03/fi-money-vector-logo-small.png" width="100px" class="img-fluid" alt="Logo">
                        </div>
                    </div>
                </section>
                        ...
                        <div class="col-12">
                            <div class="card p-0">
                                ...
                                <div class="d-flex justify-content-center text-center">
                                    <h1 class="text-dark ">
                                        <div class="font-weight-normal mb-3"> Congratualations!<br><span class="text-info">You are pre-qualified for FI Money A/c, with no hidden charges.</span></div>
                                ...
                                <div class=" flex-column text-center px-3">
                                    <h2 class="text-dark py-0 my-0"> Fi.Money </h2>
                                    <p class="py-0 mt-0 mb-3"><strong> <small> Enjoy Rs. 2500 rewards in 3 days.<br>
Money insured up to ₹5 lak
                                            </small> </strong></p>
...
<a href="https://trk.hexawebony.com/click?campaign_id=31155&pub_id=1398&source=<?php echo @$utm_source; ?>"><button class="btn btn-success w-100 py-3">Apply Now <img width="15px"
